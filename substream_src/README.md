...
```bash
> substreams gui -e mainnet.sol.streamingfast.io:443 ./substream_src-v0.1.0.spkg map_block_meta --start-block 153000000 --stop-block +1
...
```bash
> substreams run -e mainnet.sol.streamingfast.io:443 ./substream_src-v0.1.0.spkg map_filter_instructions -s 153000000 -t +50
----------- BLOCK #153,000,000 (ENZNjBKCxXQqgFxX63T6kn7DJwc7fQiwy3W3vyehtEGA) ---------------
...
```bash
substreams run -e mainnet.sol.streamingfast.io:443 ./substream_src-v0.1.0.spkg map_filter_transactions -s 153000000 -t +30
